...
For large corpora, JATE automatically uses multi-threading (spaCy NLP processing) and multi-processing (feature building) internally. No configuration needed.
