...
public class AppChiSquare extends App {
    public static void main(String[] args) throws JATEException, IOException {
        ...
        List<JATETerm> terms = new AppChiSquare().extract(solrHomePath,solrCoreName, jatePropertyFile, params);
    ...
    public List<JATETerm> extract(SolrCore core, String jatePropertyFile, Map<String, String> params) throws IOException, JATEException {
        ...
        CooccurrenceFBMaster cb = new CooccurrenceFBMaster(searcher, properties, ftb, minTTF, fcsb,
                minTCF);
