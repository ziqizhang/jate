...
public abstract class BaseEmbeddedSolrTest {
    ...
    static String solrHome = workingDir + File.separator + "testdata" + File.separator + "solr-testbed" + File.separator;
    ...
    public static void setupClass() throws Exception {
        try {
            ...
            throw new JATEException(String.format("Unable to delete index data. Please clean index directory "
                    + "[%s] manually!", solrHome + File.separator + solrCoreName + File.separator + "data"));
        }
    }
